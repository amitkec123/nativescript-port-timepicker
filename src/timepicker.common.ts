import { TimePicker as TimePickerDefinition } from "./timepicker";
import { View, Property, CSSType } from "tns-core-modules/ui/core/view";
...
@CSSType("TimePicker")
export abstract class TimePickerBase extends TimePickerDefinition {
  public hour: number;
